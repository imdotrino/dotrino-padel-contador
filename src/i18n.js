...
const DICT = {
  en: {
    ...
    rulesH: 'Rules', rulesFormH: 'New set of rules', rulesetName: 'Rules name', rulesetCopyName: '{name} (copy)',
    rulesetOwn: 'This tournament’s rules', rulesetBuiltinTime: 'Americano on time', rulesetBuiltinGames: 'Americano to 6 games',
    rulesFormEditH: 'Edit rules', rulesetUpdate: 'Save changes', rulesetSaveNew: 'Save as new rules',
    rulesetBuiltinNote: 'Built-in rules do not change: save them as new rules.',
  ...
  es: {
    ...
    rulesH: 'Reglas', rulesFormH: 'Nuevo set de reglas', rulesetName: 'Nombre de las reglas', rulesetCopyName: '{name} (copia)',
    rulesetOwn: 'Reglas de este torneo', rulesetBuiltinTime: 'Americano por tiempo', rulesetBuiltinGames: 'Americano a 6 juegos',
    rulesFormEditH: 'Editar reglas', rulesetUpdate: 'Guardar cambios', rulesetSaveNew: 'Guardar como reglas nuevas',
    rulesetBuiltinNote: 'Las reglas de fábrica no se cambian: guárdalas como reglas nuevas.',
