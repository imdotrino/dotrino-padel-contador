...
const DICT = {
  en: {
    ...
    limitEveryone_fixed: 'Everyone vs everyone', limitEveryone_rotating: 'Partner everyone',
    ...
    info_limit: 'When there are not enough courts for everyone, players rest in turns so everyone plays the same number of matches. Everyone vs everyone (fixed pairs): each pair plays every other pair once. Partner everyone (rotating partners): each player partners every other player once. Those two depend on the number of players.',
    ...
    rulesH: 'Rules', rulesetName: 'Rules name', rulesetCopyName: '{name} (copy)',
    rulesetOwn: 'This tournament’s rules', rulesetBuiltinTime: 'Americano on time', rulesetBuiltinGames: 'Americano to 6 games',
    rulesFormEditH: 'Edit rules', rulesetUpdate: 'Save', rulesetSaveNew: 'Save as new',
    rulesetBuiltinNote: 'Built-in rules cannot be changed or deleted: save them as new rules.',
  ...
  es: {
    ...
    limitEveryone_fixed: 'Todos contra todos', limitEveryone_rotating: 'Con todos',
    ...
    rulesH: 'Reglas', rulesetName: 'Nombre de las reglas', rulesetCopyName: '{name} (copia)',
    rulesetOwn: 'Reglas de este torneo', rulesetBuiltinTime: 'Americano por tiempo', rulesetBuiltinGames: 'Americano a 6 juegos',
    rulesFormEditH: 'Editar reglas', rulesetUpdate: 'Guardar', rulesetSaveNew: 'Guardar como nuevas',
    rulesetBuiltinNote: 'Las reglas de fábrica no se cambian ni se borran: guárdalas como reglas nuevas.',
