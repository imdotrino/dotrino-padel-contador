...
const DICT = {
  en: {
    ...
    rulesFormEditH: 'Edit rules', rulesetUpdate: 'Save', rulesetSaveNew: 'Save as new', rulesetDeleteBtn: 'Delete rules',
  ...
  es: {
    ...
    rulesFormEditH: 'Editar reglas', rulesetUpdate: 'Guardar', rulesetSaveNew: 'Guardar como nuevas', rulesetDeleteBtn: 'Borrar reglas',
