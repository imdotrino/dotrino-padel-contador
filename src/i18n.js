...
const DICT = {
  en: {
    ...
    period_all: 'All', period_month: 'This month', period_week: 'This week', period_today: 'Today',
    periodAria: 'Show tournaments from', periodEmpty: 'No tournaments in this period.',
  ...
  es: {
    ...
    period_all: 'Todos', period_month: 'Este mes', period_week: 'Esta semana', period_today: 'Hoy',
    periodAria: 'Mostrar los torneos de', periodEmpty: 'No hay torneos en este periodo.',
